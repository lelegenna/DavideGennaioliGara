...
/**
 * Prima finestra che l'utente vede all'avvio.
 *
 * Permette di scegliere:
 *  - Il circuito (10 piste reali F1)
 *  - Il numero di giri con lo slider (5-80)
 *  - Il meteo (generato a caso, mostrato nella label)
 *  - I 6 piloti tra i 20 del calendario F1 2025
 *  - Le gomme per ogni pilota (preselezionate in base al meteo)
 */
public class JfrmSchermataIniziale extends javax.swing.JFrame {

    // I 10 circuiti disponibili nel menù a tendina
    ...
    // I 20 piloti F1 2025: ogni riga è {nome, scuderia}
    ...
    /**
     * Genera meteo a caso e preseleziona le gomme consigliate.
     * SOLE → Morbide, NUVOLOSO → Dure, PIOGGIA → Intermedie.
     */
    private void generaMeteo() {
        ...
        switch (meteoCorrente) {
            case SOLE:     testo = "☀️ Sole";    gommaIdx = 0; break;
            case NUVOLOSO: testo = "☁️ Nuvoloso"; gommaIdx = 1; break;
            case PIOGGIA:  testo = "🌧 Pioggia";  gommaIdx = 2; break;
            default:       testo = "";           gommaIdx = 0;
        }
    ...
    /**
     * Controlla duplicati, crea la gara e apre JfrmGara.
     * Chiamato dal pulsante GARA.
     */
    ...
    private SceltaGomme parseGomme(int idx) {
        switch (idx) {
            case 1:  return SceltaGomme.DURE;
            case 2:  return SceltaGomme.INTERMEDIE;
            default: return SceltaGomme.MORBIDE;
        }
    }
